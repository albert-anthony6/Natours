...
exports.getTourStats = async (req, res) => {
    try {
        const stats = await Tour.aggregate([ // (Aggregation Pipline) - Each of the elements in this array represents one stage
            {
...
exports.getMonthlyPlan = async (req, res) => {
    try {
        ...
        const plan = await Tour.aggregate([
            ...
            {
                $project: {
                    _id: 0 // 0 meaning it won't shop up. (1 would mean it should show up)
                }
            },
            {
